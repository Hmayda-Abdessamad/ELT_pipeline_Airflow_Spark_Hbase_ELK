...
dag = DAG(  dag_id = "income_statement",default_args=args, schedule_interval = "@monthly")
...
income_statement_preprocess = SparkSubmitOperator(
    task_id="income_statement_preprocess",
    conn_id="spark-conn",
    application="jobs/python/income_statement_preprocess.py",
    dag=dag
)
...
start>>income_statement>>income_statement_preprocess>>end